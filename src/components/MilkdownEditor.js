            ...
            [
              {
                ...
                key: "ToggleBold",
                active: (view) =>
                  hasMark(view.state, view.state.schema.marks["strong"]),
              ...
              },
              {
                ...
                key: "ToggleItalic",
                active: (view) =>
                  hasMark(view.state, view.state.schema.marks["em"]),
            ...
            [
              {
                ...
                key: "ToggleLink",
                active: (view) =>
                  hasMark(view.state, view.state.schema.marks["link"]),
              },
              {
                type: "button",
                icon: "image",
      ...
      .use(
        trailing.configure(trailingPlugin, {
          shouldAppend: (lastNode, state) =>
            lastNode && !["paragraph"].includes(lastNode.type.name),
        })
      )
      .use(
